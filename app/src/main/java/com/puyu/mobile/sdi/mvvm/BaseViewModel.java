 ...
 */
public class BaseViewModel<M extends DataRepository> extends AndroidViewModel
...
//        }
    ...
    public void showWaitingDialog(DialogOption option) {
        uc.showDialogEvent.postValue(option);
    }
    ...
    protected void onCleared() {
        ...
        //我个人的理解，这个需不需要都无所谓，因为异步任务，通过ViewModel使用，
        // 触发的都是LiveData，而LiveData里已经帮我们处理了当UI销毁时的操作
        if (mCompositeDisposable != null) {
    ...
    public final class UIChangeLiveData extends SingleLiveEvent {
        private SingleLiveEvent<DialogOption> showDialogEvent;
        ...
        public SingleLiveEvent<DialogOption> getShowDialogEvent() {
