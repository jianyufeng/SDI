package com.puyu.mobile.sdi.mvvm.viewadapter.radiogroup;
...
public class ViewAdapter {
    ...
    @BindingAdapter(value = {"onCheckedChangedCommandById"}, requireAll = false)
    public static void onCheckedChangedCommandById(final RadioGroup radioGroup, final BindingCommand<Integer> bindingCommand) {
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
