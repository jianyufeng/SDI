...
import com.puyu.mobile.sdi.mvvm.view.QMUIKeyboardHelper;
...
//        viewModel.injectLifecycleProvider(this);
    ...
    protected void registorUIChangeLiveDataCallBack() {
        //加载对话框显示
        viewModel.getUC().getShowDialogEvent().observe(getViewLifecycleOwner(), new Observer<DialogOption>() {
            @Override
            public void onChanged(@Nullable DialogOption option) {
                showDialog(option);
            }
        });
        //加载对话框消失
        ...
        viewModel.getUC().getShowToastEvent().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
            public void onChanged(String o) {
                showToast(o);
            }
        });
        viewModel.getUC().getHideKeyboardEvent().observe(getViewLifecycleOwner(), new Observer() {
            @Override
    ...
    protected void hidKeyBoard() {
        QMUIKeyboardHelper.hideKeyboard(binding.getRoot());
    }
